<?php
    ...
    class Rombo extends Figura{
        ...
        public function get_form(){
			$html = '
                <input class="form-control my-2" type="number" name="lado" id="lado" placeholder="Lado">
    ...
    class Romboide extends Figura{
        ...
        public function get_form(){
			$html = '
                ...
                <input class="form-control my-2" type="number" name="altura" id="altura" placeholder="Altura">
                <button type="submit" class="btn btn-primary my-2" id="submitBtn"lado>Enviar</button>
			';
			return $html;
		}
